      ...
      <div class="row p-2 p-md-4  pb-0 pe-lg-0 pt-lg-5 align-items-center">
        <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
          ...
          <p class="lead mt-5 text-justify">
            <strong class="fw-bold">مارک داون (Markdown)</strong>
            در سال 2004 با این ایده که بتواند خواندن و نوشتن یک متن تحت وب را برای همه آسان کند و قابل تبدیل به
            خانواده HTML هم باشد به وجود آمد. از Markdown به عنوان یک استاندارد متن نویسی یاد می‌شود و بزرگترین مزیت این
            استاندارد استفاده از حروف ساده و کوتاه برای اهداف نگارشی (از جمله پررنگ کردن متن و .... ) می‌باشد
          </p>


          <blockquote class="fw-lighter q-block text-justify">
            <div>راهنمایی جامع و البته رایگان برای کسایی که دوس دارن Markdown یاد بگیرن :)</div>
            توی این کتاب که به زبان شیرین
            <span class="fw-bold text-info">پارسی</span>
           منتشر کردم سعی دارم که به صورت کامل و جامع به برسی و آموزش نحوه استفاده از سینتکس Markdown بپردازم در صورت مشاهده هرگونه مشکل میتونید اون رو با راه های ارتباطی در اختیارم قرار بدین تا اصلاح صورت بگیره
          </blockquote>
          <div
              class="d-grid gap-3 d-md-flex justify-content-md-start mb-4 mb-lg-3"
              id="main-actions">
            <a href="/book">
              <button
                  type="button"
        ...
        <div
            class="col-lg-3 offset-lg-1 p-0 overflow-hidden"
            id="hero-image">
          <svg width="100%" height="100%" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#000000" class="bi bi-markdown-fill svg-primery">
