...
const _routes = [
  {
    name: "book-Blockquotes",
    path: "/book/Blockquotes",
    component: () => import("./_nuxt/Blockquotes-BTarZ_4H.js").then((m) => m.default || m)
  },
  {
    name: "book-CodeBlocks",
    path: "/book/CodeBlocks",
    component: () => import("./_nuxt/CodeBlocks-4sf9iUEf.js").then((m) => m.default || m)
  },
  {
    name: "book-FormatingContent",
    path: "/book/FormatingContent",
    component: () => import("./_nuxt/FormatingContent-h9G5kMTI.js").then((m) => m.default || m)
  },
  {
    name: "book-Heading",
    path: "/book/Heading",
    component: () => import("./_nuxt/Heading-BmCxG684.js").then((m) => m.default || m)
  },
  {
    name: "book",
    path: "/book",
    component: () => import("./_nuxt/index-CHQ0au5z.js").then((m) => m.default || m)
  },
  {
    name: "book-Intro-HowItWork",
    path: "/book/Intro/HowItWork",
    component: () => import("./_nuxt/HowItWork-CF8_snje.js").then((m) => m.default || m)
  },
  {
    name: "book-Intro-LabTools",
    path: "/book/Intro/LabTools",
    component: () => import("./_nuxt/LabTools--6nNpj3l.js").then((m) => m.default || m)
  },
  {
    name: "book-LinkAndPhotos",
    path: "/book/LinkAndPhotos",
    component: () => import("./_nuxt/LinkAndPhotos-BNOEG4BG.js").then((m) => m.default || m)
  },
  {
    name: "book-Lists",
    path: "/book/Lists",
    component: () => import("./_nuxt/Lists-B5KTHwO7.js").then((m) => m.default || m)
  },
  {
    name: "book-Tables",
    path: "/book/Tables",
    component: () => import("./_nuxt/Tables-BQrX0xh0.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-Cxxx47Iy.js").then((m) => m.default || m)
  }
];
...
const global_plugin_aDQnViXeP9 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
});
...
const plugins = [
  ...
  global_plugin_aDQnViXeP9,
  prerender_server_LXx1wM9sKF
];
const layouts = {
  default: () => import("./_nuxt/default-Ccb9uzs7.js").then((m) => m.default || m),
  main: () => import("./_nuxt/main-DVQC9Gv0.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-C_rHlnwB.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CJNxwzLx.js").then((r) => r.default || r));
